// ============================================================================
// cve2_tb.cpp  –  Main simulation entry point
// ============================================================================
//
// Build WITHOUT waveforms:
//   see Makefile.verilator → `make build`
//
// Build WITH VCD waveform output (cve2_wave.vcd):
//   see Makefile.verilator → `make build_trace`
//
// Run:
...
int main(int argc, char** argv) {
    ...
    std::cout << "[TB] First 8 words at RAM base:\n";
